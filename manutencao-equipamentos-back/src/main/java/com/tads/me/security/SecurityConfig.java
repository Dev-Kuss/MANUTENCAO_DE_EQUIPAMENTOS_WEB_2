    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/login", "/cliente/create", "/swagger-ui/**", "/v3/api-docs/**").permitAll()
        ...
        // Adicionando JwtAuthenticationFilter antes de UsernamePasswordAuthenticationFilter
